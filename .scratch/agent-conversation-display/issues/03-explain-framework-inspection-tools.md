...
- [ ] Current-task inspection is a self-contained header and omits the redundant current task ID.
...
- [ ] Every known framework inspection omits the generic raw MCP disclosure and uses one self-contained semantic header unless an additional body adds distinct information.
